...
export const metadata: Metadata = pageMetadata({
  ...
  path: "/faq",
keywords: ["grok bots faq", "what are grok bots", "are grok bots free", "are grok bots safe", "how do grok bots work", "grok bot questions"],
});

export default function FaqPage() {
  return (
    <div className="container-x max-w-3xl py-12">
      <JsonLd data={[faqJsonLd(faqs, { dateModified: SITE.lastUpdated }), breadcrumbsJsonLd([{ name: "Home", path: "/" }, { name: "FAQ", path: "/faq" }])]} />
