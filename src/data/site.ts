export const SITE = {
  ...
  githubRepo: process.env.NEXT_PUBLIC_GITHUB_REPO ?? "V-harshith/grokbothq",
  githubUrl: `https://github.com/${process.env.NEXT_PUBLIC_GITHUB_REPO ?? "V-harshith/grokbothq"}`,
